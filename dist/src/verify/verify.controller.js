...
let VerifyController = class VerifyController {
    ...
    async verify(code) {
        ...
        if (type === 'ouvrier') {
            ...
            if (!o)
                throw new common_1.NotFoundException('Ouvrier non trouvé');
        ...
        if (type === 'engin') {
            ...
            if (!e)
                throw new common_1.NotFoundException('Engin non trouvé');
        ...
        if (!a)
            throw new common_1.NotFoundException('Appareil non trouvé');
